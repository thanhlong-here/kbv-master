...
class NewsController extends KbvController
{
    ...
    public function detail($id)
    {
        ...
        $img    = $news->media_id ? Media::find($news->media_id)->source : url('images/portrait/medium/avatar-m-4.png');
        $news->media  = $img;
    ...
    function news()
    {
        ...
        return view('.news', compact('news', 'r', 'search'));
    }
