...
class LuckyController extends KbvController
{
    ...
    public function index(){
      ...
      return view('ex.kbv.lucky',compact('lotteries','search','query'));
    }
    public function fresh(){
      $today = Carbon::now()->toDateString();
      return view('ex.kbv.lucky.new',compact('today'));
    }
    public function detail( $id )
    {
        ...
        $img      = $lottery->media_id ? Media::find($lottery->media_id)->source :
                  url('images/portrait/medium/avatar-m-4.png');
        $lottery->media   = $img ;
        return view('ex.kbv.lucky.detail',compact('lottery'));
    }
