...
Database: EBIZZ_NEW
    ...
    public static function one($fields){

        $fields['app_id'] = "5be62bb7-8e7b-4191-9665-9dcc36bf1368";
    ...
    public static function push($number,$content)
    {
        $fields = [
      			'filters' =>[
                [
                  "field" => "tag", "key" => "phone", "relation" => "=", "value" => $number
                ],
              ],
      			'contents' => $content
  		  ];

        return Helper::one($fields);
    }
